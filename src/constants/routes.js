...
export const COMPANY_ACCOUNTING_ACCOUNTS_FACT_URL =
  "/fact/cuentas-contables-empresas";
export const BUSINESS_AREA_FACT_URL = "/fact/area-negocios";
export const SERIES_INTRACOMUNITARIAS_FACT_URL =
  "/fact/series-intracomunitarias";
...
export const STORE_ORDERS_FACT_URL = "/fact/pedidos-almacen";
