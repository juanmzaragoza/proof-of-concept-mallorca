...
const ArticlesGamaForm = React.memo(({ actions, allFormData, getFormData, submitFromOutside, services, ...props }) => {
  ...
  const tabs = [
    {
      label: <FormattedMessage id={"ArticulosGama.titulo"} defaultMessage={"Artículos Gama"} />,
  ...
  useEffect(() => {
    ...
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "ArticulosGama.titulo", defaultMessage: "Articulos Gama" }), href: "/ecom/gama-articulos" },
  ...
  useEffect(() => {
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "ArticulosGama.titulo", defaultMessage: "Articulos Gama" }), href: "/ecom/gama-articulos" },
        { title: nom, href: "/ecom/gama-articulos" },
        { title: "Modificar" }
      ]);
    }
