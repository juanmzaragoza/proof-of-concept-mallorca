...
const ArticlesModelForm = React.memo(({ actions, allFormData, getFormData, submitFromOutside, services, ...props }) => {
  ...
  const tabs = [
    {
      label: <FormattedMessage id={"ArticulosModelo.titulo"} defaultMessage={"Artículos Modelo"} />,
  ...
  useEffect(() => {
    ...
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "ArticulosModelo.titulo", defaultMessage: "Articulos Modelo" }), href: "/ecom/modelo-articulos" },
  ...
  useEffect(() => {
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "ArticulosModelo.titulo", defaultMessage: "Articulos Modelo" }), href: "/ecom/modelo-articulos" },
        { title: nom, href: "/ecom/modelo-articulos" },
        { title: "Modificar" }
      ]);
    }
