...
const PaymentDocumentsForm = React.memo(
  ({
    actions,
    allFormData,
    getFormData,
    ...
    const [tabIndexWithError, setTabIndexWithError] = useState(
      { [PAYMENT_DOCS_TAB_INDEX]: true },
      { [ACCOUNTING_DATA_TAB_INDEX]: true }
    );
        ...
        component: (
          <AccountingDataTab
            setIsValid={(value) =>
              setTabIndexWithError({
                ...tabIndexWithError,
                [ACCOUNTING_DATA_TAB_INDEX]: !value,
              })
            }
            editMode={editMode}
            getFormData={getFormData}
