...
const ExpirationTypeForm = React.memo(({ actions, allFormData, getFormData, submitFromOutside, services, ...props }) => {
  ...
  const tabs = [
    {
      label: <FormattedMessage id={"TiposVencimiento.titulo"} defaultMessage={"Tipos Vencimiento"} />,
  ...
  useEffect(() => {
    ...
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "TiposVencimiento.titulo", defaultMessage: "Tipos Vencimiento" }), href: "/ecom/tipos-vencimiento" },
  ...
  useEffect(() => {
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "TiposVencimiento.titulo", defaultMessage: "Tipos Vencimiento" }), href: "/ecom/tipos-vencimiento" },
        { title: nom, href: "/ecom/tipos-vencimiento" },
        { title: "Modificar" }
      ]);
    }
