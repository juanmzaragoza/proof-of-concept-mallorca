...
const ContactTab = ({ formData, setFormData, getFormData, ...props }) => {
  const [touched, handleTouched, addValidity, formIsValid] = useTabForm({
    fields: { [CLIENTE_SECTION_INDEX]: false },
  ...
  const CP_TEXT = props.intl.formatMessage({
    id: "Clientes.cpTexto",
    defaultMessage: "Código postal texto",
  });
  const POBLACION_TEXT = props.intl.formatMessage({
    id: "Clientes.poblacionTexto",
    defaultMessage: "Población texto",
  });
  const PROV_TEXT = props.intl.formatMessage({
    id: "Clientes.provinciaTexto",
    defaultMessage: "Provincia texto",
  });
