...
const ArticlesFamilyForm = React.memo(({ actions, allFormData, getFormData, submitFromOutside, services, ...props }) => {
  ...
  const tabs = [
    {
      label: <FormattedMessage id={"FamiliaArticulos.titulo"} defaultMessage={"Familia Artículos"} />,
  ...
  useEffect(() => {
    ...
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "FamiliaArticulos.titulo", defaultMessage: "Familia Artículos" }), href: "/familia-articulos" },
  ...
  useEffect(() => {
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "FamiliaArticulos.titulo", defaultMessage: "Familia Artículos" }), href: "/familia-articulos" },
        { title: nom, href: "/familia-articulos" },
        { title: "Modificar" }
      ]);
    }
