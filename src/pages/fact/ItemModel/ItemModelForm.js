...
const ArticlesModelForm = React.memo(({ actions, allFormData, getFormData, submitFromOutside, services, ...props }) => {
  ...
  useEffect(() => {
    ...
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "ArticulosModelo.titulo", defaultMessage: "Articulos Modelo" }), href: "/fact/articulos-modelo" },
  ...
  useEffect(() => {
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "ArticulosModelo.titulo", defaultMessage: "Articulos Modelo" }), href: "/fact/articulos-modelo" },
        { title: nom, href: "/fact/articulos-modelo" },
        { title: "Modificar" }
      ]);
    }
