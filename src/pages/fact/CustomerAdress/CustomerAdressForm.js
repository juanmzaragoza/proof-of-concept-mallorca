...
const CustomerAddressForm = React.memo(
  ({
        ...
        actions.setBreadcrumbHeader([
          {
            ...
            href: "/fact/direcciones-clientes",
          },
          {
            title: props.intl.formatMessage({
              id: "Comun.nuevo",
    ...
    useEffect(() => {
      if (isEditable()) {
        const nomComercial = getFormData("descCliAdreComCodi");
        ...
        actions.setBreadcrumbHeader([
          ...
          { title: nom, href: "/fact/direcciones-clientes" },
          { title: nameSelectedTab },
        ]);
      }
    }, [getFormData("descCliAdreComCodi"), nameSelectedTab]);
