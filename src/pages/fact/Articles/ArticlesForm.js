...
const ArticlesForm = React.memo(
  ({
    ...
    const [tabIndexWithError, setTabIndexWithError] = useState({
      ...
      [PRICE_TAB_INDEX]: true,
      [STOCK_TAB_INDEX]: true,
      [PRESENTACION_TAB_INDEX]: false,
      [PROVEEDORES_TAB_INDEX]: false,
      [PERSONALIZACION_TAB_INDEX]: false,
      [ESCANDALLOS_TAB_INDEX]: false,
    ...
    const tabs = [
      ...
      {
        label: (
          <FormattedMessage id={"Articulos.precio"} defaultMessage={"Precio"} />
        ),
        key: PRICE_TAB_INDEX,
      ...
      },
      {
        label: (
          <FormattedMessage
            id={"Proveedores.tabs.personalizacion"}
        ...
        component: (
          <PersonalizacionTab
            setIsValid={(value) =>
              setTabIndexWithError({
                ...tabIndexWithError,
                [PERSONALIZACION_TAB_INDEX]: !value,
              })
            }
            editMode={editMode}
            getFormData={getFormData}
