...
import EscaladoTab from "./EscaladoTab";
...
const RatesForm = React.memo(
  ({
    ...
    const tabs = [
      ...
      disabledEscalado
        ? {
            ...getTranslations("TiposVencimiento.escalado", "Escalado"),
            key: ESCALADO_TAB_INDEX,
            error: tabHasError(ESCALADO_TAB_INDEX),
            component: (
              <EscaladoTab
                setIsValid={(value) =>
                  setTabIndexWithError({
                    ...tabIndexWithError,
                    [ESCALADO_TAB_INDEX]: !value,
                  })
                }
                editMode={editMode}
                getFormData={getFormData}
