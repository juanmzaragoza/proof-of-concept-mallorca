...
const FinalesFacturaForm = React.memo(({ actions, allFormData, getFormData, submitFromOutside, services, ...props }) => {
  ...
  const tabs = [
    {
      label: <FormattedMessage id={"FinalFacturas.titulo"} defaultMessage={"Final Facturas"} />,
  ...
  useEffect(() => {
    ...
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "FinalFacturas.titulo", defaultMessage: "Final Facturas" }), href: "/fact/finales-facturas" },
  ...
  useEffect(() => {
    if (isEditable()) {
      ...
      actions.setBreadcrumbHeader([
        { title: props.intl.formatMessage({ id: "FinalFacturas.titulo", defaultMessage: "Final Facturas" }), href: "/fact/finales-facturas" },
        { title: nom, href: "/fact/finales-facturas" },
        { title: "Modificar" }
      ]);
    }
  }, [getFormData('nom')]);
