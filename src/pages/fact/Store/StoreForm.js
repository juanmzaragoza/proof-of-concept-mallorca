...
const StoreForm = React.memo(
  ({
    ...
    const [tabIndexWithError, setTabIndexWithError] = useState({
      ...
      [PERIOD_TAB_INDEX]: false,
      [INITIAL_SITUATION_TAB_INDEX]: false,
      [LOCATION_TAB_INDEX]: false,
