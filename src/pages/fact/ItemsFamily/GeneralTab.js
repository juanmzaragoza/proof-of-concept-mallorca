...
import {
  AVISO_ALBARANES_CLIENTE_SELECTOR_VALUES,
  TIPO_FAMILIA_ARTICULO_SELECTOR_VALUES,
  TIPO_SERVEI_FAMILIA_ARTICULO_SELECTOR_VALUES,
...
const GeneralTab = ({ formData, setFormData, getFormData, ...props }) => {
  ...
  const TraduccionesConfiguration = {
    title: props.intl.formatMessage({
  ...
  const tabs = [
    {
      ...
      component: (
        <GenericForm
          formComponents={ContabilidadConfiguration}
          emptyPaper={true}
          ...
          handleIsValid={(value) =>
            addValidity(ACCOUNTING_SECTION_TAB_INDEX, value)
          }
    ...
    },
    {
      ...
      label: (
        <FormattedMessage
          id={"FamiliaArticulos.operaciones"}
      ...
      component: (
        <GenericForm
          formComponents={OperacionesConfiguration}
          emptyPaper={true}
          setFormData={setFormData}
          getFormData={getFormData}
          loading={props.loading}
          ...
          onSubmit={() => props.onSubmitTab(formData)}
          handleIsValid={(value) =>
            addValidity(OPERATION_SECTION_TAB_INDEX, value)
          }
    ...
    },
    {
      ...
      component: (
        <GenericForm
          formComponents={OpcionesConfiguration}
          emptyPaper={true}
          setFormData={setFormData}
          getFormData={getFormData}
          loading={props.loading}
    ...
    },
    {
      ...
      component: (
        <ExpandableGrid
          ...
          enabled={props.editMode}
          configuration={TraduccionesConfiguration}
        />
      ),
    },
  ];
