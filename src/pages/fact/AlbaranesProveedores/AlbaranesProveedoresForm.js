...
const AlbaranesProveedoresForm = React.memo(
  ({
    actions,
    allFormData,
    getFormData,
    ...
    const tabs = [
      ...
      {
        ...getTranslations("AlbaranesProveedor.tabs.varios", "Varios"),
        key: MORE_TAB_INDEX,
        ...
        actions.setBreadcrumbHeader([
          {
            ...
            href: "/fact/albaranes-proveedores",
          },
          {
            title: props.intl.formatMessage({
              id: "Comun.nuevo",
    ...
    useEffect(() => {
      if (isEditable()) {
        ...
        actions.setBreadcrumbHeader([
          ...
          { title: nom, href: "/fact/albaranes-proveedores" },
