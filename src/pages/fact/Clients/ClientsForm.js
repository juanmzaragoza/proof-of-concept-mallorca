...
const ClientsForm = React.memo(
  ({
    ...
    const [operari, setOperari] = useState(false);
    ...
    const tabsComercial = [
      ...
      },
      {
        label: (
          <FormattedMessage
            id={"Proveedores.tabs.documentos"}
...

      {
        label: (
          <FormattedMessage
            ...
            defaultMessage={"Otra Aplicaciones"}
          />
        ),
