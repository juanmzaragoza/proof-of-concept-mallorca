...
const FactoringLineForm = React.memo(
  ({
    actions,
    allFormData,
    getFormData,
    ...
    useEffect(() => {
      if (isEditable()) {
        const nomComercial = getFormData("contracteNumero");
        ...
        actions.setBreadcrumbHeader([
          ...
          { title: nom, href: "/fact/linias-factoring" },
          { title: "Modificar" },
        ]);
      }
    }, [getFormData("contracteNumero")]);
