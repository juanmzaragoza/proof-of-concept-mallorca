...
const SuppliersOffersForm = React.memo(
  ({
    ...
    const tabs = [
      ...
      {
        ...getTranslations("OfertaProveedor.liniasOferta", "Linias de la Oferta"),
        key: LINIAS_OFERTA_TAB_INDEX,
        error: tabHasError(LINIAS_OFERTA_TAB_INDEX),
        component: "Línias de la Oferta pendiente del backend",
      },
        ...
        actions.setBreadcrumbHeader([
          {
            title: props.intl.formatMessage({
              ...
              defaultMessage: "OfertasProveedores",
            }),
            href: "/fact/ofertas-proveedores",
          },
          { title: nom, href: "/fact/ofertas-proveedores" },
