...
const GeneralTab = ({ formData, setFormData, getFormData, ...props }) => {
  ...
  const LONG = props.intl.formatMessage({ id: "Clientes.contacto.longitud", defaultMessage: "Longitud" });
  const LAT = props.intl.formatMessage({ id: "Clientes.contacto.latitud", defaultMessage: "Latitud" });
  ...
  const DIR_EXCLUSIVA = props.intl.formatMessage({ id: "Clientes.dreccion_exclusiva", defaultMessage: "Dirección exclusiva" });
  const BLOQUEJAT = props.intl.formatMessage({ id: "Clientes.bloqueado", defaultMessage: "Bloqueado" });
...

    {
...

      {
        placeHolder: props.intl.formatMessage({
          ...
          defaultMessage: "Tipo Extranjero"
        }),
        type: 'select',
        key: 'tipusEstranger',
        breakpoints: {
  ...
  const clienteDireccionesComerciales= {
    ...
    columns: [
      ...
      { name: 'direccionExclusivaEnvio', title: DIR_EXCLUSIVA,
     
      getCellValue: row => (row.direccionExclusivaEnvio && row.direccionExclusivaEnvio === "S") ?
      <Chip label="SI" variant="outlined" />
      :
      <Chip label="NO" variant="outlined" /> },
      {
        name: 'defecte', title: DEFECTE,
        getCellValue: row => (row?.domiciliDefecte && row.domiciliDefecte === "S") ?
          <Chip label="SI" variant="outlined" />
          :
          <Chip label="NO" variant="outlined" />
      },
      {
        name: 'bloquejat', title: BLOQUEJAT,
        getCellValue: row => (row?.bloquejada && row.bloquejada === "S") ?
          <Chip label="SI" variant="outlined" />
          :
          <Chip label="NO" variant="outlined" />
      },
